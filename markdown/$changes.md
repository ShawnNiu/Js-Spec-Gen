...
|[chartDataLabel](../markdown/chartdatalabel.md)|_Property_ > height|Returns the height, in points, of the chart data label. Null if chart data label is not visible. Read-only.|1.8|
