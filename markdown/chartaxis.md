...
|type|string|Represents the axis type. Read-only. Possible values are: Invalid, Category, Value, SeriesAxis.|[1.7](../requirement-sets/excel-api-requirement-sets.md)|
...
| Parameter	   | Type	|Description|
|:---------------|:--------|:----------|
|value|double|The value of custom crosses|
